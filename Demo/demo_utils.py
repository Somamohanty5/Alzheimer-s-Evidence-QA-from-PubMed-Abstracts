...
# ---------- Paths specific to demo/ ----------

DEMO_ROOT = Path(__file__).resolve().parent
DEMO_DATA_DIR = DEMO_ROOT / "demo_data"
DEMO_RUNS_DIR = DEMO_ROOT / "runs"
DEMO_INDEX_DIR = DEMO_ROOT / "index" / "whoosh_index"


def create_demo_directories() -> None:
    for path in [DEMO_DATA_DIR, DEMO_RUNS_DIR, DEMO_INDEX_DIR]:
